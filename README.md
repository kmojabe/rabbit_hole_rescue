...
## WireFrames
User Auth Modal
![alt text](https://drive.google.com/open?id=14EnJ057SSFjqH_waHWb1b3Zf3KQr6iVj)

Chrome Extension View
![alt text](https://drive.google.com/open?id=1KENs8ZwDmLpTfnTKKz364bA51Yx6vu2x)

History View Page
![alt text](https://drive.google.com/open?id=1kzHpb3TXv8-hMeJV8ygwf2u92XzNjkRU)
...
### Day 1
  - Build the skeleton Chrome extension
...
### Day 2
  ...
  - Identify methods from Google API’s for collection of browser data
  - Implement above methods
  - Begin design of Web application

### Day 3
  - Begin implementation of visualization on Web application using D3 library
  - item 2 
  - item 3 
